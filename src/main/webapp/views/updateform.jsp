    ...
    <form id="updateform" enctype="multipart/form-data" method="post">
        <p align="center">
            <table border="1" width="50%" height="80%" align='center'>
                <tr>
                    <td colspan="3" align="center"><h2>회원정보 수정</h2></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        &nbsp;&nbsp;&nbsp;
                        <input type="email" name="email" readonly="readonly" value="${user.email}" id="email" size="30" maxlength=50 required="required" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#f5f5f5">
                    ...
                    <td>
                        &nbsp;&nbsp;&nbsp;
                        <input type="password" name="pw" id="pw" size="20" required="required"/><div id="pwDiv"></div>
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#f5f5f5">
                ...
                <tr>
                    ...
                    <td>&nbsp;&nbsp;&nbsp;
                        <input type="text" name="nickname" id="nickname" size="20" pattern="([a-z, A-Z, 가-힣]){2,}"
                               required="required" title="닉네임은 문자 2자 이상입니다." value="${user.nickname}"/>
...
<script>
    ...
    document.getElementById("updateform").addEventListener("submit",function(e){
        ...
        pattern3 = /[~!@#$%^&*()_+|<>?:{}]/;// 특수문자
        if(!pattern1.test(pw) || !pattern2.test(pw) || !pattern3.test(pw) || pw.length
            < 8) {
